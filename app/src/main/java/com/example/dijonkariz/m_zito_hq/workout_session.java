...
public class workout_session extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Add_Wrkout(), "ADD WORKOUT");
        adapter.addFragment(new Diet_Plan_Wrkout(), "DIET PLAN");
        adapter.addFragment(new Past_Wrkout(), "PAST WORKOUTS");
        adapter.addFragment(new Record_Wrkout(), "RECORD SESSION");
